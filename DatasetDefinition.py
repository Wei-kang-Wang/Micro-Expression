...
# 将RGB图像转为YUV图像，再判断U和V层极差是否在10以内，即输入图片是否是灰度图
...
class AffectNet_Twoviews(Dataset):
    ...
    def __init__(self, df, dataset_str, img_dir, occ_dir):
        ...
        if dataset_str in ['train']:
            ...
            # 如果是训练集，就进行随机旋转，裁剪，翻转等预处理，并用compose串联起来。
